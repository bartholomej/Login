 ...
 * @subpackage lexicon
 *
 * @author BART!: https://github.com/bartholomej
 */
...
$_lang['login.or_forgot_username'] = 'Anebo neznáte uživatelské jméno?';
$_lang['login.reset_password'] = 'Resetovat heslo';
$_lang['login.username'] = 'Uživatelské jméno';
$_lang['login.user_err_nf_email'] = 'Uživatel s tímto emailem nebyl nalezen.';
$_lang['login.user_err_nf_username'] = 'Uživatelské jméno nebylo nalezeno.';